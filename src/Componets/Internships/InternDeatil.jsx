...
useEffect(()=>{
  ...
  const response=await axios.get(`https://internshipbackend-7qgp.onrender.com/api/internship/${id}`)
...
const submitApplication= async()=>{
  const text=document.getElementById("text")
    if (text.value==="") {
      ...
      await axios.post("https://internshipbackend-7qgp.onrender.com/api/application",bodyJson).then((res)=>{
